...
import 'package:quizhouse/views/result_page.dart';
import 'package:quizhouse/widgets/applogo.dart';
import 'package:quizhouse/widgets/quiztile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(onPressed: (){
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ResultPage(incorrect: _incorrect,total: total, notattempted: _notAttempted, correct: _correct,)));
            ...
            children: [
              questionSnaphot.docs.isEmpty
                ...
                child: Center(child: Row(
                  ...
                  children: [
                    Text("No Data"),
                    TextButton(onPressed: () {  },child:Text("Add Questions?",style: TextStyle(color: Colors.blue),)),
                  ],
                ),),
              ):
              InfoHeader(
